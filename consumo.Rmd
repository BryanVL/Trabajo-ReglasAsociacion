...
#La estructura de esta columna es la de un vector de tipo 'hms', clase utilizada para almacenar valores de hora del día a partir de un vector numerico indicando hora, minutos y segundos. Su longitud es la misma que el nº de filas del dataset.
str(consumo_ds$Time)
